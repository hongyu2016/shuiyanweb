 ...
 * */
	putfileQiniu(file, name) {
		return _asyncToGenerator(function* () {
			...
			return yield up(uploadToken, newname, filepath, putExtra);
		})();
	}
	/*
 * 删除七牛上的图片
 * */
	deleteQiniuImg(file) {
		return _asyncToGenerator(function* () {
			...
			return yield deleteFile(filePath);
		})();
	}
	/*
 * 查询七牛上的图片文件
